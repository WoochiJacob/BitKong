                    ...
                    <FormBox key={data.label}>
                        ...
                        {data.form === 'input' && (
                            <>
                                <Input
                                    ...
                                    setValue={setValue}
                                />
                                {errors.title && data.label === 'title' && <Error>제목을 입력해주세요.</Error>}
                                {errors.price && data.label === 'price' && <Error>가격을 입력해주세요.</Error>}
                                {errors.phone && data.label === 'phone' && <Error>핸드폰 번호를 입력해주세요.</Error>}
                        ...
                        {data.form === 'select' && (
                            <>
                                ...
                                />
                                {errors.category && <Error>카테고리를 선택 해주세요.</Error>}
